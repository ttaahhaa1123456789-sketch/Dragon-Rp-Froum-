    ...
    <style>
        * {
        ...
        input[type="file"] {
            ...
            color: transparent; /* مخفی کردن متن پیش‌فرض */
        }
...
<body>
    ...
    <footer>
        ...
        <p style="font-size: 14px; margin-top: 10px; color: var(--accent);">طراحی شده توسط <span>@Mashin_Mazndarn</span></p>
    </footer>
